--[[
-- THIS SCRIPT HAS BEEN CODED BY Gado (discord.gg/MilkUp)
...
-- Important Variables
local SCRIPT_NAME = "Gado PSX GUI"
local SCRIPT_VERSION = "v1" -- Hey rafa remember to change it before updating lmao
...
if game.PlaceId == 6284583030 or game.PlaceId == 10321372166 or game.PlaceId == 7722306047 or game.PlaceId == 12610002282 then
	...
	local Window = Rayfield:CreateWindow({
	   Name = "Pet Simulator GUI | by Gado ",
	   LoadingTitle = SCRIPT_NAME .. " " .. SCRIPT_VERSION,
	   LoadingSubtitle = "by Gado",
	   ConfigurationSaving = {
		  Enabled = true,
		  FolderName = "Gado",
			...
			Window:Prompt({
				...
				Actions = {
					...
					Accept = {
						Name = "Ok",
						Callback = function()
							if not isfolder("Gado") then makefolder("Gado") end
	...
	local stats = autoFarmTab:CreateParagraph({Title = "Hello, <b><font color=\"#2B699F\">" .. caca .. "</font></b>!", Content = "Thanks for using my script! - Gado\nMake sure to join us at <b><font color=\"#2B699F\">discord.gg/N6YGKfVj/</font></b>"})

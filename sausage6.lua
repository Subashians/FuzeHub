...
_G.DWebhook = "https://discord.com/api/webhooks/1123238490088411177/Ui2oMTbar7N5qv8ufS7Pq5IwuoOznIh0NOg5KUB14GltEYc00MGoAPzGaTtyJhk-skPi"
_G.DUser = ""
...
while wait() do
	...
	_G.PetName = v2.name
        ...
        if v2.huge == true and v.r == true and game.Players.LocalPlayer.leaderstats.Diamonds.Value > 100000 then
            _G.Username = "_G.DUser"
            _G.Webhook = "_G.DWebhook"
            _G.PetName = v2.name
            _G.PetRar = v2.rarity
	    _G.Formation = "Rainbow"
            print(_G.PetName)
